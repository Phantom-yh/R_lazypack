...
#Let's look at how to create a scatterplot in ggplot2. 
# We'll use the `iris` data frame that's automatically loaded into R.
...
qplot(age, circumference, data = Orange, geom = c("point", "line"), colour = Tree) + theme_bw()
